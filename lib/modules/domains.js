...
var domains = function (tools) {
  ...
  return {
    ...
    create_record: function (domain, type) {
      // Variables can be null based on their requirements.
      // These are stated in the DigitalOcean API docs
      var body = {
        type: type
      }
      // Create the wrapper and add optionals and variables methods
    ...
    update_record: function (domain, record) {
      // Prepare the payload
      var body = {}
      // Initialize the wrapper and add attribute methods
      var wrapper = tools._wrapper(function (callback) {
